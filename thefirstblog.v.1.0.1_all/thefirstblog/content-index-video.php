...
<div class="tfb-article-content col-md-10 col-sm-10 audio">
    <header>
        <?php
        
        if (!$options['hide_post_type_icon']) {
            ?>
                <div class="hidden-xs tfb-post-type-icon icon-film" title="<?php echo __('Video', 'TheFirstBlog'); ?>"></div>
            <?php
        }
        ...
        <ul class="tfb-article-info2">
            ...
            <li><span class="visible-xs"><span class="icon-chat2"></span>&nbsp;&nbsp;<?php comments_popup_link(__('No Comment', 'TheFirstBlog'), __('1 Comment', 'TheFirstBlog'), __('% Comments', 'TheFirstBlog'), 'comment-link', ''); ?></span></li>
    ...
    <section class="tfb-the-content index video">
        <?php
            $_readMoreLinkText = '';
