...
<div class="tfb-article-content col-md-10 col-sm-10">
    <header>
        ...
        if (!$options['hide_post_type_icon']) {
            ?><div class="hidden-xs tfb-post-type-icon icon-pushpin" title="<?php echo __('Standard Post', 'TheFirstBlog'); ?>"></div><?php
        }
        ...
        <ul class="tfb-article-info2">  <!-- Change Later: visible-xs or hidden -->
            <?php
